            ...
            foreach ($categories as $category) {
                ...
                <div class="programme-box">
                    ...
                    <a href="<?php echo $link; ?>">
                        <div>
                            <div class="frontpage-section-image frontpage-programme-background"
            ...
            <div class="row">
                ...
                if ($homepagePubs->have_posts()) :
                    while ($homepagePubs->have_posts()) :
                        ...
                        ?>
                        <div class="programme-box events-box">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a class="black-text"
                                       href="<?php echo the_field('link') ?>"><?php echo the_excerpt() ?></a>
                                </div>
                            </div>
                        </div>
                    <?php
                        ...
                        <div class="programme-box publication-box">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <h3><?php echo the_title() ?></h3>
                                    <p class="author-text">Closing date <?php the_field('closing_date') ?></p>
